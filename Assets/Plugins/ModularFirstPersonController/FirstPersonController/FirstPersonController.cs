...
public class FirstPersonController : MonoBehaviour
{
    ...
    #region Arma
    [SerializeField] public Transform weapon; // Referencia al modelo del arma
    [SerializeField] public Vector3 weaponSprintPosition; // Posición del arma al hacer sprint
    [SerializeField] public Vector3 weaponCrouchPosition; // Posición del arma al agacharse
    [SerializeField] public Vector3 weaponIdlePosition; // Posición normal del arma
    [SerializeField] public float weaponTransitionSpeed = 5f; // Velocidad de transición del arma
    #endregion
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        // Weapon Transform Field
        fpc.weapon = (Transform)EditorGUILayout.ObjectField("Weapon Model", fpc.weapon, typeof(Transform), true);

        // Weapon Positions
        fpc.weaponSprintPosition = EditorGUILayout.Vector3Field("Weapon Sprint Position", fpc.weaponSprintPosition);
        fpc.weaponCrouchPosition = EditorGUILayout.Vector3Field("Weapon Crouch Position", fpc.weaponCrouchPosition);
        fpc.weaponIdlePosition = EditorGUILayout.Vector3Field("Weapon Idle Position", fpc.weaponIdlePosition);

        // Weapon Transition Speed
        fpc.weaponTransitionSpeed = EditorGUILayout.FloatField("Weapon Transition Speed", fpc.weaponTransitionSpeed);
        #endregion
